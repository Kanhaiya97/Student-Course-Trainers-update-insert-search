    ...
    <div class="card shadow-lg border-0 rounded-lg mt-5">
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                 <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control py-4" cols="30" rows="10" required placeholder="Enter Page Description" required>
                ...
                <div class="form-group">
                    <label class="small mb-1" for="course_image">Upload Course Image</label>
                    <input type="file" name="course_image" class="form-control py-4" aria-describedby="emailHelp" required />
                </div>
               <div class="row mb-3">
                 <div class="col-md-6">
                        <div class="form-group">
                            <label class="small mb-1" for="course_fee">Course Fee</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="trainer_id" class="form-control py-4" required>
